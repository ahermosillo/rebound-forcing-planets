        ...
        case REB_GRAVITY_MERCURIUS:
        {
            ...
            switch (r->ri_mercurius.mode){
                case 0: // WHFAST part
                {
                    ...
                    // printf("\ncalculate acceleration, accel initialized to 0\n");
                    ...
                    // printf("ax: %20.16e, ay: %20.16e, az: %20.16e\n", particles[1].ax*(2*M_PI/365.25)*(2*M_PI/365.25), particles[1].ay*(2*M_PI/365.25)*(2*M_PI/365.25), particles[1].az*(2*M_PI/365.25)*(2*M_PI/365.25));
#else // OPENMP
                    particles[0].ax = 0; 
                    particles[0].ay = 0; 
                    particles[0].az = 0; 
