...
void reb_output_ascii(struct reb_simulation* r, char* filename){
    ...
    for (int i=0;i<N;i++){
        ...
        fprintf(of,"%25.16e\t%25.16e\t%25.16e\t%25.16e\t%25.16e\t%25.16e\t%25.16e\n",r->t,p.x,p.y,p.z,p.vx,p.vy,p.vz);
    }
    fclose(of);
}
...
void reb_output_orbits(struct reb_simulation* r, char* filename){
    ...
    for (int i=1;i<N;i++){
        ...
        fprintf(of,"%25.16e\t%25.16e\t%25.16e\t%25.16e\t%25.16e\t%25.16e\t%25.16e\t%25.16e\t%25.16e\n",r->t,o.a,o.e,o.inc,o.Omega,o.omega,o.l,o.P,o.M);
