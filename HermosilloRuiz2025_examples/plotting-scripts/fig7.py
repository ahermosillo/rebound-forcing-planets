...
fparams = np.array(([0.0, 0.0, 0.0,26.43],
                    [0.0,0.0,0.03,0.022],
...
indxPlanets = [2,3]
file = "../4planet-Nep-edamp-fig7/fourplanet-tsiganis-Nep-edamp.txt"
...
# axs[1].plot(t_eq2,eeq_line,color='#354E6E',linestyle='-.',rasterized=True) 
